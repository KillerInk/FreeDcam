...
public class SettingKeys{
    ...
    public final static Key<SettingMode> YuvSize = new Key(SettingMode.class, R.string.aps_yuvsize);
    ...
    public final static Key<SettingMode> ExposureLock = new Key(SettingMode.class, R.string.aps_aps_exposurelock);
    ...
    public static class Key<T>
    {
        ...
        public String toString() {
            return ContextApplication.getStringFromRessources(ressourcesStringID);
        }
    }
}
