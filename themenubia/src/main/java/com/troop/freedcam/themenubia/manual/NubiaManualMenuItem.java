 ...
 */
public class NubiaManualMenuItem extends LinearLayout implements View.OnClickListener, AbstractManualParameter.I_ManualParameterEvent, I_ManualParameter
{

    private static String TAG = NubiaManualMenuItem.class.getSimpleName();
    Context context;
    public TextView textViewName;
    public TextView textViewValue;
    private LinearLayout toggleButton;
    public final String name;
    NubiaManualMenuHandler manualMenuHandler;
    ...
    String[] stringValues;
    NubiaManualMenuItem manualMenuItem;
    protected AppSettingsManager appSettingsManager;

    public NubiaManualMenuItem(Context context, String name, NubiaManualMenuHandler manualMenuHandler, AppSettingsManager appSettingsManager) {
        super(context);
    ...
    {
        inflater.inflate(R.layout.manual_menu_item_nubia, this);
    }
