 ...
 */
public class NubiaLongExposure extends LongExposureChild {
    public NubiaLongExposure(Context context, ExpandableGroup group, String name, AppSettingsManager appSettingsManager, String settingsname) {
