 ...
 */
public class NubiaExpandableChild extends ExpandableChild {
    public NubiaExpandableChild(Context context, ExpandableGroup group, String name, AppSettingsManager appSettingsManager, String settingsname) {
