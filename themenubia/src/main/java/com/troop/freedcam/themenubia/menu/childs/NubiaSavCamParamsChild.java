 ...
 */
public class NubiaSavCamParamsChild extends SaveCamParasExpandableChild {
    public NubiaSavCamParamsChild(Context context, ExpandableGroup group, String name, AppSettingsManager appSettingsManager, String settingsname) {
