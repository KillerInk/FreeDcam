 ...
 */
public class NubiaGuideChild extends ExpandableChildGuide {
    public NubiaGuideChild(Context context, ExpandableGroup group, String name, AppSettingsManager appSettingsManager, String settingsname) {
