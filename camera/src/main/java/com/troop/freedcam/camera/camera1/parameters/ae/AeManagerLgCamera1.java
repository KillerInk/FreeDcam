...
public class AeManagerLgCamera1 extends AeManager
{
    ...
    public void setExposureTime(int valueToSet, boolean setToCamera) {
        parameters.set(ContextApplication.getStringFromRessources(R.string.lg_shutterspeed), manualExposureTime.getStringValues()[valueToSet]);
    ...
    public void setIso(int valueToSet, boolean setToCamera) {
        ...
        {
            parameters.set(ContextApplication.getStringFromRessources(R.string.lg_iso), manualIso.getStringValues()[valueToSet]);
            ((ParametersHandler) cameraControllerInterface.getParameterHandler()).SetParametersToCamera(parameters);
    ...
    private void setToAuto()
    {
        ...
        parameters.set(ContextApplication.getStringFromRessources(R.string.lg_manual_mode_reset), "1");
        parameters.set(ContextApplication.getStringFromRessources(R.string.lg_iso), ContextApplication.getStringFromRessources(R.string.auto_));
        parameters.set(ContextApplication.getStringFromRessources(R.string.lg_shutterspeed), "0");
        ((ParametersHandler) cameraControllerInterface.getParameterHandler()).SetParametersToCamera(parameters);
    ...
    private void setToManual()
    {
        ...
        parameters.set(ContextApplication.getStringFromRessources(R.string.lg_manual_mode_reset), "0");
        ((ParametersHandler) cameraControllerInterface.getParameterHandler()).SetParametersToCamera(parameters);
