...
public class Camera1FeatureDetectorTask extends AbstractFeatureDetectorTask
{
    ...
    {
        return ContextApplication.getStringFromRessources(id);
    }
    ...
    public void detect()
    {
        ...
        for (int i = 0; i < cam_ids.size(); i++)
        {
            ...
            SettingsManager.get(SettingKeys.selfTimer).setValues(ContextApplication.getContext().getResources().getStringArray(R.array.selftimervalues));
            SettingsManager.get(SettingKeys.selfTimer).set(SettingsManager.get(SettingKeys.selfTimer).getValues()[0]);

            SettingsManager.getGlobal(SettingKeys.GuideList).setValues(ContextApplication.getContext().getResources().getStringArray(R.array.guidelist));
            ...
            SettingsManager.get(SettingKeys.VIDEO_AUDIO_SOURCE).set(ContextApplication.getStringFromRessources(R.string.video_audio_source_default));
            SettingsManager.get(SettingKeys.VIDEO_AUDIO_SOURCE).setValues(ContextApplication.getContext().getResources().getStringArray(R.array.video_audio_source));
            ...
            try {
                if (parameters.get(camstring(R.string.video_stabilization_supported)).equals(camstring(R.string.true_)))
                {
                    ...
                    SettingsManager.get(SettingKeys.VideoStabilization).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.video_stabilization));
                    SettingsManager.get(SettingKeys.VideoStabilization).setValues(new String[]{ContextApplication.getStringFromRessources(R.string.true_), ContextApplication.getStringFromRessources(R.string.false_)});
                }
    ...
    private void detectAutoHdr(Camera.Parameters parameters) {
        ...
        try {
            ...
            if (autohdr != null
                ...
                hdrVals.add(camstring(com.troop.freedcam.camera.R.string.off_));

                if (Scenes.contains(camstring(R.string.scene_mode_hdr))) {
                    hdrVals.add(camstring(com.troop.freedcam.camera.R.string.on_));
                }
    ...
    private void detectManualWhiteBalance(Camera.Parameters parameters) {
        ...
        else
        {
            ...
            if (parameters.get(ContextApplication.getStringFromRessources(R.string.max_wb_cct)) != null) {
                wbmax = ContextApplication.getStringFromRessources(R.string.max_wb_cct);
            }
            else if (parameters.get(ContextApplication.getStringFromRessources(R.string.max_wb_ct))!= null)
                wbmax = ContextApplication.getStringFromRessources(R.string.max_wb_ct);

            if (parameters.get(ContextApplication.getStringFromRessources(R.string.min_wb_cct))!= null) {
                wbmin = ContextApplication.getStringFromRessources(R.string.min_wb_cct);
            } else if (parameters.get(ContextApplication.getStringFromRessources(R.string.min_wb_ct))!= null)
                wbmin = ContextApplication.getStringFromRessources(R.string.min_wb_ct);

            if (arrayContainsString(SettingsManager.get(SettingKeys.WhiteBalanceMode).getValues(), ContextApplication.getStringFromRessources(R.string.manual)))
                wbModeval = ContextApplication.getStringFromRessources(R.string.manual);
            else if (arrayContainsString(SettingsManager.get(SettingKeys.WhiteBalanceMode).getValues(), ContextApplication.getStringFromRessources(R.string.manual_cct)))
                wbModeval = ContextApplication.getStringFromRessources(R.string.manual_cct);
    ...
    private void detectManualIso(Camera.Parameters parameters) {
        ...
        if (!SettingsManager.get(SettingKeys.M_ManualIso).isPresetted()) {
            ...
            if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK) {
                ...
                try {
                    if (parameters.get(ContextApplication.getStringFromRessources(R.string.min_iso)) != null && parameters.get(ContextApplication.getStringFromRessources(R.string.max_iso)) != null) {
                        SettingsManager.get(SettingKeys.M_ManualIso).setIsSupported(true);

                        int min = Integer.parseInt(parameters.get(ContextApplication.getStringFromRessources(R.string.min_iso)));
                        int max = Integer.parseInt(parameters.get(ContextApplication.getStringFromRessources(R.string.max_iso)));
                        if (SettingsManager.getInstance().getFrameWork() == Frameworks.Xiaomi) {
                            ...
                            SettingsManager.get(SettingKeys.M_ManualIso).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.continuous_iso));
                    ...
                    } else if (parameters.get(ContextApplication.getStringFromRessources(R.string.hw_sensor_iso_range)) != null) {
                        SettingsManager.get(SettingKeys.M_ManualIso).setIsSupported(true);
                        String t[] = parameters.get(ContextApplication.getStringFromRessources(R.string.hw_sensor_iso_range)).split(",");
                        ...
                        SettingsManager.get(SettingKeys.M_ManualIso).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.hw_sensor_iso));
                    } else if (parameters.get(ContextApplication.getStringFromRessources(R.string.lg_iso)) != null) {
                        SettingsManager.get(SettingKeys.M_ManualIso).setIsSupported(true);
                        ...
                        SettingsManager.get(SettingKeys.M_ManualIso).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.lg_iso));
                    }
                }catch (NumberFormatException ex)
                {
                    Log.WriteEx(ex);
    ...
    private void detectManualExposureTime(Camera.Parameters parameters)
    {
        ...
        if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK)
        {
            ...
            SettingsManager.get(SettingKeys.M_ExposureTime).setValues(ContextApplication.getContext().getResources().getStringArray(R.array.mtk_shutter));
        ...
        {
            //htc shutter
            if (parameters.get(ContextApplication.getStringFromRessources(R.string.shutter)) != null) {
                Log.d(TAG, "ManualExposureTime HTC");
                SettingsManager.get(SettingKeys.M_ExposureTime).setIsSupported(true);
                SettingsManager.get(SettingKeys.M_ExposureTime).setValues(ContextApplication.getContext().getResources().getStringArray(R.array.htc));
                SettingsManager.get(SettingKeys.M_ExposureTime).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.shutter));
                SettingsManager.get(SettingKeys.M_ExposureTime).setType(SettingsManager.SHUTTER_HTC);
            }
            //lg shutter
            else if (parameters.get(ContextApplication.getStringFromRessources(R.string.lg_shutterspeed_values)) != null) {
                Log.d(TAG, "ManualExposureTime LG");
                SettingsManager.get(SettingKeys.M_ExposureTime).setType(SettingsManager.SHUTTER_LG);
                ArrayList<String> l = new ArrayList(Arrays.asList(parameters.get(ContextApplication.getStringFromRessources(R.string.lg_shutterspeed_values)).replace(",0", "").split(",")));
                l.remove(0);
                SettingsManager.get(SettingKeys.M_ExposureTime).setValues(l.toArray(new String[l.size()]));
                SettingsManager.get(SettingKeys.M_ExposureTime).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.lg_shutterspeed));
                SettingsManager.get(SettingKeys.M_ExposureTime).setIsSupported(true);
            }
            //meizu shutter
                ...
                SettingsManager.get(SettingKeys.M_ExposureTime).setIsSupported(true);
                SettingsManager.get(SettingKeys.M_ExposureTime).setValues(ContextApplication.getContext().getResources().getStringArray(R.array.shutter_values_meizu));
    ...
    private String[] getSupportedShutterValues(long minMillisec, long maxMiliisec, boolean withautomode) {
        String[] allvalues = ContextApplication.getContext().getResources().getStringArray(R.array.shutter_values_autocreate);
        boolean foundmin = false;
        boolean foundmax = false;
        ArrayList<String> tmp = new ArrayList<>();
        if (withautomode)
            tmp.add(ContextApplication.getStringFromRessources(R.string.auto_));
        for (int i = 0; i < allvalues.length; i++) {
            String s = allvalues[i];
            if (!s.equals(ContextApplication.getStringFromRessources(R.string.auto_))) {
                float a;
                if (s.contains("/")) {
    ...
    private void detectNonZslmanual(Camera.Parameters parameters) {
        if(parameters.get("non-zsl-manual-mode")!=null)
        {
            ...
            SettingsManager.get(SettingKeys.NonZslManualMode).setValues(new String[]{ContextApplication.getStringFromRessources(com.troop.freedcam.camera.R.string.on_), ContextApplication.getStringFromRessources(com.troop.freedcam.camera.R.string.off_)});
        }
    }
    ...
    private void detectManualSaturation(Camera.Parameters parameters)
    {
        if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK)
        {
            ...
            try {
                int min = 0, max = 0;
                if (parameters.get(ContextApplication.getStringFromRessources(R.string.lg_color_adjust_max)) != null
                        && parameters.get(ContextApplication.getStringFromRessources(R.string.lg_color_adjust_min)) != null) {
                    Log.d(TAG, "Saturation: LG");
                    min = Integer.parseInt(parameters.get(ContextApplication.getStringFromRessources(R.string.lg_color_adjust_min)));
                    max = Integer.parseInt(parameters.get(ContextApplication.getStringFromRessources(R.string.lg_color_adjust_max)));
                    SettingsManager.get(SettingKeys.M_Saturation).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.lg_color_adjust));
    ...
    private void detectManualFocus(Camera.Parameters parameters) {
        ...
        if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK)
        {
            ...
            max = 1023;
            step = 10;
            SettingsManager.get(SettingKeys.M_Focus).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.afeng_pos));
            Log.d(TAG, "MF MTK");
        }
        else {
            //lookup old qcom
            ...
            try {
                ...
                //huawai mf
                if(parameters.get(ContextApplication.getStringFromRessources(R.string.hw_vcm_end_value)) != null && parameters.get(ContextApplication.getStringFromRessources(R.string.hw_vcm_start_value)) != null)
                {
                    Log.d(TAG,"Huawei MF");
                    SettingsManager.get(SettingKeys.M_Focus).setMode(camstring(R.string.manual));
                    SettingsManager.get(SettingKeys.M_Focus).setType(-1);
                    SettingsManager.get(SettingKeys.M_Focus).setIsSupported(true);
                    max = Integer.parseInt(parameters.get(ContextApplication.getStringFromRessources(R.string.hw_vcm_end_value)));
                    min = Integer.parseInt(parameters.get(ContextApplication.getStringFromRessources(R.string.hw_vcm_start_value)));
                    Log.d(TAG,"min/max mf:" + min+"/"+max);
                    step = 10;
                    SettingsManager.get(SettingKeys.M_Focus).setCamera1ParameterKEY(ContextApplication.getStringFromRessources(R.string.hw_manual_focus_step_value));
                }
    ...
    private void detectedPictureFormats(Camera.Parameters parameters)
    {
        ...
        if (false)
        {
            ...
            if (SettingsManager.getInstance().getFrameWork() == Frameworks.MTK) {
                ...
                if (formats.contains(ContextApplication.getStringFromRessources(R.string.bayer_)))
                {
                    Log.d(TAG, "create rawformats");
                    ArrayList<String> tmp = new ArrayList<>();
                    String[] forms = formats.split(",");
                    for (String s : forms) {
                        if (s.contains(ContextApplication.getStringFromRessources(R.string.bayer_)))
                        {
                            tmp.add(s);
                        }
                    }
