...
public class ManualToneMapCurveApi2 implements EventBusLifeCycle
{
    ...
    private Camera2Controller cameraControllerInterface;

    private float[] toneCurve;



    public ManualToneMapCurveApi2(Camera2Controller cameraUiWrapper)
    {
        this.cameraControllerInterface = cameraUiWrapper;
    ...
    public class Contrast extends AbstractParameter
    {
        ...
        public Contrast(CameraControllerInterface cameraUiWrapper) {
    ...
    public class Brightness extends AbstractParameter
    {
        ...
        public Brightness(CameraControllerInterface cameraUiWrapper) {
    ...
    public class ColorParameter extends AbstractParameter
    {
        ...
        float currentfloat;
        float defaultvalue;
        public ColorParameter(CameraControllerInterface cameraUiWrapper, float color[], float defaultvalue) {
    ...
    private void setTonemap()
    {
        ...
        cameraControllerInterface.captureSessionHandler.SetParameterRepeating(CaptureRequest.TONEMAP_CURVE, tonemapCurve,true);
    }
