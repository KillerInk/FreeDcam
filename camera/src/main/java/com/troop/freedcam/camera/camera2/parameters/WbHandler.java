...
public class WbHandler
{
    ...
    {
        if (!wbMode.equals(ContextApplication.getStringFromRessources(R.string.off)))
        {
            //if ON or any other preset set the colorcorrection to fast to let is use hal wb
            colorCorrectionMode.SetValue(ContextApplication.getStringFromRessources(R.string.fast),true);
        ...
        else //if OFF
        {
            ...
            colorCorrectionMode.SetValue(ContextApplication.getStringFromRessources(R.string.colorcorrection_transform_matrix),true);
     ...
     * this can create color artifacts.</p>
        ...
        public ViewState getViewState() {
            try {
                ...
                else if (cameraUiWrapper.getParameterHandler().get(SettingKeys.WhiteBalanceMode).GetStringValue().equals(ContextApplication.getStringFromRessources(R.string.off)))
