package com.troop.freedcam.camera.camera1.lge.hardware;
...
public class LGCameraRef
{
    ...
    private void init_classes() throws ClassNotFoundException, NoSuchMethodException {
        CLASS_LGCAMERA =  Class.forName("com.troop.freedcam.camera.camera1.lge.hardware.LGCamera");
        CLASS_LGPARAMETERS = Class.forName("com.troop.freedcam.camera.camera1.lge.hardware.LGCamera$LGParameters");
