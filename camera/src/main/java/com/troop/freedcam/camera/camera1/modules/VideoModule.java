...
public class VideoModule extends AbstractVideoModule
{
    ...
    public VideoModule(CameraControllerInterface cameraUiWrapper, Handler mBackgroundHandler, Handler mainHandler) {
    ...
    private void loadProfileSpecificParameters()
    {
        ...
        else
        {
            ...
            {
                cameraUiWrapper.getParameterHandler().get(SettingKeys.VideoHighFramerate).SetValue(ContextApplication.getStringFromRessources(com.troop.freedcam.camera.R.string.off_), true);
            }
        }
