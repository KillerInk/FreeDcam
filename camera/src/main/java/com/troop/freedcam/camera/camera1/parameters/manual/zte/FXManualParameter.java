...
package com.troop.freedcam.camera.camera1.parameters.manual.zte;
...
public class FXManualParameter extends BaseManualParameter {
    ...
    {
        parameters.set(ContextApplication.getStringFromRessources(R.string.morpho_effect_type), String.valueOf(valueToSet));
