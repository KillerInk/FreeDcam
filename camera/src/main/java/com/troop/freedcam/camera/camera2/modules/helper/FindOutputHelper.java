package com.troop.freedcam.camera.camera2.modules.helper;
...
public class FindOutputHelper
{
    ...
    public Output getHuaweiOutput(CameraHolderApi2 cameraHolder) {
        ...
        if (SettingsManager.get(SettingKeys.dualPrimaryCameraMode).isSupported())
        {
            ...
            if (camera.equals(ContextApplication.getStringFromRessources(R.string.hw_dualcamera_Primary)) || camera.equals(ContextApplication.getStringFromRessources(R.string.hw_dualcamera_Dual))) {
                if (findColorOutput(cameraHolder, picFormat, output))
                    return getStockOutput(cameraHolder);
            }
            else if (camera.equals(ContextApplication.getStringFromRessources(R.string.hw_dualcamera_Secondary)))
            {
    ...
    private boolean findMonoOutput(CameraHolderApi2 cameraHolder, String picFormat, Output output) {
        ...
        if (output.raw_format == ImageFormat.RAW_SENSOR && !SettingsManager.get(SettingKeys.secondarySensorSize).isSupported())
            ...
            if (picFormat.equals(ContextApplication.getStringFromRessources(R.string.pictureformat_dng16))
                    || picFormat.equals(ContextApplication.getStringFromRessources(R.string.pictureformat_jpg_p_dng))
                    || picFormat.equals(ContextApplication.getStringFromRessources(R.string.pictureformat_bayer))) {
    ...
    public Output getStockOutput(CameraHolderApi2 cameraHolder) {
        ...
        | picFormat.equals(ContextApplication.getStringFromRessources(R.string.pictureformat_bayer10))) {
