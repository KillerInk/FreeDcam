...
public class VirtualLensFilter extends  BaseModeParameter {
    ...
    public VirtualLensFilter(Parameters parameters, CameraControllerInterface cameraUiWrapper)
    {
        ...
        stringvalues = ContextApplication.getStringArrayFromRessource(R.array.virtual_lensfilter_colors);
        asU = ContextApplication.getStringArrayFromRessource(R.array.virtual_lensfilter_asu);
    }
