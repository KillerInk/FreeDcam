...
public class BaseISOManual extends BaseManualParameter {
    ...
    private String cur_iso_mode = ContextApplication.getStringFromRessources(R.string.auto_);
    ...
    protected void set_manual()
    {
        ...
        if (!cameraUiWrapper.getParameterHandler().get(SettingKeys.IsoMode).GetStringValue().equals(ContextApplication.getStringFromRessources(R.string.manual)))
            cameraUiWrapper.getParameterHandler().get(SettingKeys.IsoMode).SetValue(ContextApplication.getStringFromRessources(R.string.manual), true);
    ...
    protected void set_to_auto()
    {
        ...
        if (cameraUiWrapper.getParameterHandler().get(SettingKeys.IsoMode).GetStringValue().equals(ContextApplication.getStringFromRessources(R.string.manual)))
            cameraUiWrapper.getParameterHandler().get(SettingKeys.IsoMode).SetValue(ContextApplication.getStringFromRessources(R.string.auto_), true);
