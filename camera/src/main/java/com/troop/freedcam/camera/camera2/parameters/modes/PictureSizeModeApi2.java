...
public class PictureSizeModeApi2 extends BaseModeApi2
{
    ...
    public void SetValue(String valueToSet, boolean setToCamera)
    {
        ...
        size = valueToSet;
        if (setToCamera &&
                (SettingsManager.get(SettingKeys.PictureFormat).get().equals(ContextApplication.getStringFromRessources(R.string.pictureformat_jpeg))
                    || SettingsManager.get(SettingKeys.PictureFormat).get().equals(ContextApplication.getStringFromRessources(R.string.pictureformat_jpg_p_dng)))
                )
        {
