...
public class HuaweiAeHandler extends AeHandler {
    ...
    protected void setIso(int valueToSet,boolean setToCamera) {
        ...
        {
            cameraUiWrapper.captureSessionHandler.SetParameterRepeating(CaptureRequestEx.HUAWEI_SENSOR_ISO_VALUE, Integer.parseInt(manualISoApi2.getStringValues()[valueToSet]),setToCamera);
        }
    }
