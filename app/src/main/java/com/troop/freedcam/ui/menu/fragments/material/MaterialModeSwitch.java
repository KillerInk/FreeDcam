 ...
 */
public class MaterialModeSwitch extends ModuleSwitchHandler {
    ...
    public MaterialModeSwitch(View activity, AppSettingsManager appSettingsManager, Fragment fragment)
    {
