 ...
 */
public class MaterialNightSwitch extends NightModeSwitchHandler {
    ImageView textView;
    ...
    public MaterialNightSwitch(View activity, AppSettingsManager appSettingsManager,Fragment fragment)
    {
