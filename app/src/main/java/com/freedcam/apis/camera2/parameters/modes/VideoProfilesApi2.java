...
public class VideoProfilesApi2 extends BaseModeApi2
{
    ...
    public VideoProfilesApi2(I_CameraUiWrapper cameraUiWrapper)
    {
    ...
    private void lookupDefaultProfiles(HashMap<String, VideoMediaProfile> supportedProfiles)
    {
        ...
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_480P))
                supportedProfiles.put("480p",new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_480P),"480p", VideoMode.Normal,true));
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_720P))
            {
                supportedProfiles.put("720p", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_720P), "720p", VideoMode.Normal,true));
            }
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_1080P))
                supportedProfiles.put("1080p", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_1080P), "1080p", VideoMode.Normal,true));
        } catch (Exception e) {
            Logger.exception(e);
        }
            /*try {
        ...
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_TIME_LAPSE_480P))
                supportedProfiles.put("Timelapse480p", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_TIME_LAPSE_480P), "Timelapse480p", VideoMode.Timelapse,false));
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_TIME_LAPSE_720P))
                supportedProfiles.put("Timelapse720p", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_TIME_LAPSE_720P), "Timelapse720p", VideoMode.Timelapse,false));
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_TIME_LAPSE_1080P))
                supportedProfiles.put("Timelapse1080p", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_TIME_LAPSE_1080P),"Timelapse1080p", VideoMode.Timelapse,false));
        } catch (Exception e) {
            Logger.exception(e);
        }
            /*try {
        ...
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CAMCORDER_QUALITY_4kUHD))
            {
                CamcorderProfile fourk = CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CAMCORDER_QUALITY_4kUHD);
        ...
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CAMCORDER_QUALITY_TIME_LAPSE_4kUHD))
                supportedProfiles.put("Timelapse4kUHD", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CAMCORDER_QUALITY_TIME_LAPSE_4kUHD),"Timelapse4kUHD", VideoMode.Timelapse,false));
        } catch (Exception e) {
            Logger.exception(e);
        }

        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_1080P))
                supportedProfiles.put("1080pHFR",new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_1080P),"1080pHFR", VideoMode.Highspeed,true));
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_2160P))
                supportedProfiles.put("2016pHFR", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_2160P),"2016HFR", VideoMode.Highspeed,true));
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_720P))
                supportedProfiles.put("720pHFR", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_720P),"720pHFR", VideoMode.Highspeed,true));
        } catch (Exception e) {
            Logger.exception(e);
        }
        try {
            if (CamcorderProfile.hasProfile(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_480P))
                supportedProfiles.put("480pHFR", new VideoMediaProfile(CamcorderProfile.get(((CameraHolder)cameraUiWrapper.GetCameraHolder()).CurrentCamera, CamcorderProfile.QUALITY_HIGH_SPEED_480P),"480pHFR", VideoMode.Highspeed,true));
        } catch (Exception e) {
            Logger.exception(e);
        }
    }
