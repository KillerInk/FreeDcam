...
import com.freedcam.apis.camera1.parameters.manual.ShutterManualG2pro;
...
public class LG_G2pro extends AbstractDevice
{
    ...
    public LG_G2pro(Context context, Parameters parameters, I_CameraUiWrapper cameraUiWrapper) {
