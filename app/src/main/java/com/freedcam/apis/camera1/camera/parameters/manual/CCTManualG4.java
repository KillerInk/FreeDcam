...
public class CCTManualG4 extends BaseCCTManual {
    public CCTManualG4(Camera.Parameters parameters, String value, int max, int min, ParametersHandler parametersHandler, float step, String wbmode) {
        super(parameters, value, max, min, parametersHandler, step, wbmode);
    }

    public CCTManualG4(Camera.Parameters parameters,ParametersHandler parametersHandler) {
