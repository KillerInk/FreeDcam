...
tiffFields[] = {
	...
	{ TIFFTAG_GPSIFD, 1, 1, TIFF_IFD8, 0, TIFF_SETGET_IFD8, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 0, "GPSIFDOffset", (TIFFFieldArray*) &gpsFieldArray },
...
_TIFFCreateAnonField(TIFF *tif, uint32 tag, TIFFDataType field_type)
{
	 ...
	 */
	(void) sprintf(fld->field_name, "Tag %d", (int) tag);
