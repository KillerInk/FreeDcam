...
static TIFFFieldArray gpsFieldArray;
...
tiffFields[] = {
	...
	{ TIFFTAG_GPSIFD, 1, 1, TIFF_IFD8, 0, TIFF_SETGET_IFD8, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 0, "GPSIFDOffset", &gpsFieldArray },
	...
	{ TIFFTAG_OPC2, -1, -1, TIFF_UNDEFINED, 0, TIFF_SETGET_C32_UINT8, TIFF_SETGET_C32_UINT8, FIELD_CUSTOM, 1, 1, "OpcodeList2" , NULL},
	{ TIFFTAG_OPC3, -1, -1, TIFF_UNDEFINED, 0, TIFF_SETGET_C32_UINT8, TIFF_SETGET_C32_UINT8, FIELD_CUSTOM, 1, 1, "OpcodeList3" , NULL},
	//{ TIFFTAG_OPC2, -1, -1, TIFF_UNDEFINED, FIELD_CUSTOM, 1, 1,			"OpcodeList2"},
	{ TIFFTAG_CFAREPEATPATTERNDIM, 2, 2, TIFF_SHORT, 0, TIFF_SETGET_UINT16_PAIR, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 0, "CFARepeatPatternDim", NULL },
	...
	//{ TIFFTAG_WHITELEVEL, -2, -1, TIFF_SHORT, 0, TIFF_SETGET_C16_UINT32, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 1, "WhiteLevel", NULL },
    ...
    { TIFFTAG_NOISEPROFILE, -1, -1, TIFF_SRATIONAL, 0, TIFF_SETGET_C16_FLOAT, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 1, "NoiseProfile", NULL },
...
static TIFFField
gpsFields[] = {
	{ GPSTAG_GPSVersionID, 1, 1, TIFF_RATIONAL, 0, TIFF_SETGET_DOUBLE, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 1, 0, "GPSVersionID", NULL },
...
static TIFFFieldArray
gpsFieldArray = { tfiatGps, 0, TIFFArrayCount(gpsFields), gpsFields };
