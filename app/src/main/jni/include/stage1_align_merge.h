#ifndef HALIDE__C______Users___troop___Desktop___FreeDcam___halide_generator___libs___arm64___v8a___stage1_align_merge_h
#define HALIDE__C______Users___troop___Desktop___FreeDcam___halide_generator___libs___arm64___v8a___stage1_align_merge_h
#include <stdint.h>
...
int stage1_align_merge(struct halide_buffer_t *_inputs_buffer, int32_t _minoffset, int32_t _maxoffset, int32_t _l1mindistance, int32_t _l1maxdistance, struct halide_buffer_t *_merge_spatial_output_buffer);

HALIDE_FUNCTION_ATTRS
int stage1_align_merge_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *stage1_align_merge_metadata();
