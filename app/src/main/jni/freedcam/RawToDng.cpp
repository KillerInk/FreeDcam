...
JNIEXPORT void JNICALL Java_freed_jni_RawToDng_Create(JNIEnv *env, jobject thiz);
...
JNIEXPORT void JNICALL Java_freed_jni_RawToDng_Release(JNIEnv *env, jobject thiz);
