...
#include <jpeglib.h>
#include <jmorecfg.h>
    JNIEXPORT jobject JNICALL Java_com_defcomk_jni_staxxer_StaxxerJNI_Create(JNIEnv *env, jobject thiz);
    JNIEXPORT jbyteArray JNICALL Java_com_defcomk_jni_staxxer_StaxxerJNI_GetRGB(JNIEnv *env,jobject thiz, jbyteArray fromCamera, jint Length);
    JNIEXPORT jbyteArray JNICALL Java_com_defcomk_jni_staxxer_StaxxerJNI_GetMerged(JNIEnv *env, jobject thiz,jobject handler);
    JNIEXPORT void JNICALL Java_com_defcomk_jni_staxxer_StaxxerJNI_StoreMerged(JNIEnv *env, jobject thiz, jobject handler, jbyteArray fromRS);
