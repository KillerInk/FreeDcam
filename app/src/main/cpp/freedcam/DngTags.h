...
static const TIFFField dngFields[] = {
        { TIFFTAG_OPC2, -3, -3, TIFF_BYTE, 0, TIFF_SETGET_C32_UINT8, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 1, "OpcodeList2" , NULL},
        { TIFFTAG_OPC3, -3, -3, TIFF_BYTE, 0, TIFF_SETGET_C32_UINT8, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 0, 1, "OpcodeList3" , NULL},
